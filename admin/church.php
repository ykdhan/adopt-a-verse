...
<div class="remodal" data-remodal-id="edit-profile-picture" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
    ...
    <div class="lightbox">
        <form method="post" enctype="multipart/form-data" action="sql-update-church-profile-picture.php">
        ...
        <section class="last-section">
            <button type="submit" class="admin-submit" id="button-edit-profile-picture" onclick="edit_profile_picture()">Change Image</button>
        </section>
    ...
    var ajaxObj = new XMLHttpRequest();
        ajaxObj.onreadystatechange= function() { if(ajaxObj.readyState == 4) { if(ajaxObj.status == 200) {
            ...
            if (ajaxObj.responseText == "no\n") {
                ...
                if (profile_pic != null) {
                    document.getElementById('church-profile-picture').style.backgroundImage = '../../img/profile/'+profile_pic;
                }
